...
export const translations = {
  'zh-CN': {
    ...
    wsllExpRuleSet: 'wsll_exp.ini',
    wsllExpRuleSetDesc: '默认生成结果固定采用 wsll_exp.ini 中的规则、策略组和默认选项。',
    copySubconverterUrl: '复制配置地址',
    copiedSubconverterUrl: '已复制！',
    clashRuleBaseUrl: 'Clash 基础配置地址',
    clashRuleBaseUrlPlaceholder: '默认使用 wsll_exp.ini 中的 clash_rule_base',
    ...
    customRuleGroups: '规则组 URL 配置',
    addCustomRuleGroup: '添加规则组',
    removeCustomRuleGroup: '删除规则组',
    customRuleGroupNamePlaceholder: '规则组名称（例如：隐私防护）',
    addRuleSetUrl: '添加规则集 URL',
    removeRuleSetUrl: '删除 URL',
  ...
  'en-US': {
    ...
    wsllExpRuleSet: 'wsll_exp.ini',
    wsllExpRuleSetDesc: 'Generated configs use the rules, policy groups, and defaults from wsll_exp.ini.',
    copySubconverterUrl: 'Copy Config URL',
    copiedSubconverterUrl: 'Copied!',
    clashRuleBaseUrl: 'Clash Rule Base URL',
    clashRuleBaseUrlPlaceholder: 'Defaults to the clash_rule_base from wsll_exp.ini',
    ...
    customRuleGroups: 'Rule Group URL Configuration',
    addCustomRuleGroup: 'Add Rule Group',
    removeCustomRuleGroup: 'Remove Rule Group',
    customRuleGroupNamePlaceholder: 'Rule group name (e.g. Privacy Protection)',
    addRuleSetUrl: 'Add Rule Set URL',
    removeRuleSetUrl: 'Remove URL',
    ...
    outboundNames: {
      ...
      'icloud美区': '🇺🇸 iCloud US',
      '隐私防护': '🛡️ Privacy Protection',
      'AdBlock': '🚫 AdBlock',
      '应用净化': '🧹 App Purification',
    ...
    policyDefaultOption: 'Policy group default option',
    followBuiltInDefault: 'Follow built-in default',
  ...
  'fa': {
    ...
    wsllExpRuleSet: 'wsll_exp.ini',
    wsllExpRuleSetDesc: 'پیکربندی خروجی از قوانین، گروه‌های سیاست و پیش‌فرض‌های wsll_exp.ini استفاده می‌کند.',
    ...
    customRuleGroups: 'پیکربندی URL گروه قوانین',
    addCustomRuleGroup: 'افزودن گروه قوانین',
    removeCustomRuleGroup: 'حذف گروه قوانین',
    customRuleGroupNamePlaceholder: 'نام گروه قوانین (مثال: Privacy Protection)',
    addRuleSetUrl: 'افزودن URL مجموعه قوانین',
    removeRuleSetUrl: 'حذف URL',
  ...
  'ru': {
    ...
    wsllExpRuleSet: 'wsll_exp.ini',
    wsllExpRuleSetDesc: 'Генерируемые конфиги используют правила, группы политик и значения по умолчанию из wsll_exp.ini.',
    ...
    customRuleGroups: 'Настройка URL групп правил',
    addCustomRuleGroup: 'Добавить группу правил',
    removeCustomRuleGroup: 'Удалить группу правил',
    customRuleGroupNamePlaceholder: 'Название группы правил (например: Privacy Protection)',
    addRuleSetUrl: 'Добавить URL набора правил',
    removeRuleSetUrl: 'Удалить URL',
