...
export const translations = {
  'zh-CN': {
    ...
    shortenLinks: '生成短链接',
    ruleSelection: '规则选择',
    ruleSelectionTooltip: '规则集来源：Sing-Box 使用 lyc8503/sing-box-rules，Clash 使用 MetaCubeX/meta-rules-dat，Surge 使用 NSZA156/surge-geox-rules',
  ...
  'en-US': {
    ...
    ruleSelectionTooltip: 'Rule set sources: Sing-Box uses lyc8503/sing-box-rules, Clash uses MetaCubeX/meta-rules-dat, Surge uses NSZA156/surge-geox-rules',
  ...
  'fa': {
    ...
    ruleSelectionTooltip: 'منبع مجموعه قوانین: Sing-Box از lyc8503/sing-box-rules، Clash از MetaCubeX/meta-rules-dat و Surge از NSZA156/surge-geox-rules استفاده می‌کند',
  ...
  'ru': {
    ...
    ruleSelectionTooltip: 'Источники наборов правил: Sing-Box использует lyc8503/sing-box-rules, Clash — MetaCubeX/meta-rules-dat, Surge — NSZA156/surge-geox-rules',
